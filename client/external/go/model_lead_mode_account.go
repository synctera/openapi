...
// LeadModeAccount struct for LeadModeAccount
type LeadModeAccount struct {
	// Account ID
	...
	Relationships []SchemasRelationship `json:"relationships"`
...
func (o LeadModeAccount) MarshalJSON() ([]byte, error) {
...
type NullableLeadModeAccount struct {
	value *LeadModeAccount
	isSet bool
}

func (v NullableLeadModeAccount) Get() *LeadModeAccount {
	return v.value
}

func (v *NullableLeadModeAccount) Set(val *LeadModeAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableLeadModeAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableLeadModeAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeadModeAccount(val *LeadModeAccount) *NullableLeadModeAccount {
	return &NullableLeadModeAccount{value: val, isSet: true}
}

func (v NullableLeadModeAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeadModeAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
