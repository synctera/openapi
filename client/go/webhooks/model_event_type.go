...
const (
	...
	ACCOUNT_STATUS_CHANGED EventType = "ACCOUNT.STATUS_CHANGED"
	TRANSACTION EventType = "TRANSACTION.*"
	TRANSACTION_POSTED EventType = "TRANSACTION.POSTED"
	TRANSACTION_FAILED EventType = "TRANSACTION.FAILED"
	KYC EventType = "KYC.*"
	KYC_CUSTOMER_MANUAL_REVIEW EventType = "KYC.CUSTOMER_MANUAL_REVIEW"
	KYC_PASS EventType = "KYC.PASS"
	KYC_FAILED_MANUAL_REVIEW EventType = "KYC.FAILED_MANUAL_REVIEW"
	KYC_FOUND_ON_WATCHLIST EventType = "KYC.FOUND_ON_WATCHLIST"
	KYC_ADDITIONAL_DOC_REQUIRED EventType = "KYC.ADDITIONAL_DOC_REQUIRED"
	LEDGER EventType = "LEDGER.*"
	LEDGER_BALANCE_CHANGED_ACH_REVERSALS EventType = "LEDGER.BALANCE_CHANGED.ACH_REVERSALS"
	LEDGER_BALANCE_CHANGED_INTEREST EventType = "LEDGER.BALANCE_CHANGED.INTEREST"
	LEDGER_BALANCE_CHANGED_WIRES EventType = "LEDGER.BALANCE_CHANGED.WIRES"
	LEDGER_BALANCE_CHANGED_CHECK_DEPOSIT EventType = "LEDGER.BALANCE_CHANGED.CHECK_DEPOSIT"
	CARD EventType = "CARD.*"
	CARD_FULFILLMENT_UPDATE EventType = "CARD.FULFILLMENT_UPDATE"
	CARD_TERMINATION EventType = "CARD.TERMINATION"
	CARD_STATUS_CHANGE EventType = "CARD.STATUS_CHANGE"
	RECONCILIATION EventType = "RECONCILIATION.*"
	RECONCILIATION_PROCESSED EventType = "RECONCILIATION.PROCESSED"
)
