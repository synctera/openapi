...
`func NewAccount(accountNumber string, status Status, relationships []Relationship, ) *Account`
...
`func (o *Account) GetRelationships() []Relationship`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *Account) GetRelationshipsOk() (*[]Relationship, bool)`
...
`func (o *Account) SetRelationships(v []Relationship)`
